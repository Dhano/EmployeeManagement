 ...
 * Time: 10:38 PM
 */
if(isset($_POST['access_denied'])) {
    $toShow = $_POST['access_denied'];
    echo "<div id='access-denied'>
    <div id='spam'>
        <h1>
            <spam>X</spam>
            Access Denied(403)
        </h1>
        <p>$toShow <br/><br/><button type='button' onclick='location.reload()' class='btn custom-outline outline-danger' id='retry_btn'> Retry</button>
            <br>
            <small>
                ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
            </small>
...
} else if (isset($_POST['access_granted_login'])){
    echo "<head>
